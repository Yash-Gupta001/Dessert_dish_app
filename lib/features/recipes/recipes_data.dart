  ...
  static const List<Recipe> dessertMenu = [
    ...
    Recipe(
      ...
      instructions: [
        ...
        'Roll remaining crust to fit top of pie; place over filling. Trim, seal and flute edges.',
        'Cut slits in crust.',
        'Beat egg white until foamy; brush over crust.',
        'Sprinkle crust with sugar.',
        'Cover edges loosely with foil.',
        'Bake at 375 degrees F for 25 minutes.',
        'Remove foil and bake until crust is golden brown and filling is bubbly, about 20-25 minutes longer.',
        'Cool on a wire rack.',
      ],
